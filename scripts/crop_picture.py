...
def detect_background(image: Image.Image, alpha_threshold: int) -> tuple[int, int, int]:
...
def main() -> int:
    ...
    print(f"Done. Processed {len(image_files)} image(s); cropped {changed}; output: {output_dir}")
    return 0
